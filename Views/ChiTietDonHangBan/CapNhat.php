...
<div class="col-md-12 mt-2">
    ...
    <hr>
        <form method="post" class="form-group col-md-7" style="margin: auto;" enctype="multipart/form-data">
            ...
            <select name="idsanpham" class="form-control">
                ...
                <?php if(!empty($listProduct))
                    foreach ($listProduct as $item) : extract($item)?>
                        ...
                        <option value="<?= $item['ID']?>" data-price_km="<?= $item['GiaKhuyenMai']?>"> 
                            <?= $item['TenSanPham']?>
                        </option>
                <?php endforeach;?>    
            </select><br>
            ...
            <input type="text"  id="gia_km" value="" name="giakhuyenmai" class="form-control"><br>
...
<script>
    ...
    var price_km = selectedOption.data('price_km');

    document.getElementById("dongiaapdung").value = price;
    document.getElementById("gia_km").value = price_km;
});
</script>