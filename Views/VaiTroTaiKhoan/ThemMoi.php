...
<div class="col-md-12 mt-2">
    <span class="h3 m-2">Thêm vai trò tài khoản</span>
    <span>
    ...
    <hr>
    <div style="text-align: center;"><?php if (isset($output)) {echo $output;}  ?></div>
    <form method="post" class="form-group col-md-7" style="margin: auto;" enctype="multipart/form-data">
        <label class="h6">Tên vai trò</label>
        <input type="text" value=""name="tenvaitro" class="form-control"><br>
        ...
        <a class="btn btn-warning" href="../VaiTroTaiKhoan/DanhSach">Quay lại</a>
