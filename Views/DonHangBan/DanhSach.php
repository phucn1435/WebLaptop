    ...
    <input onclick="return confirm('Bạn muốn xóa?')" type="submit" name="delete" value="Delete" class="btn btn-danger">
        ...
        if(!empty($result)) {
            ...
            <tr style="text-align: center; background: <?php if($i % 2 != 0) { echo "#ccc";}?>">
                ...
                <td>
                    <a style="padding: 7px 5px; font-size: 14px; background: #25539e ; color: #fff; border-radius: 5px;" href="../ChiTietDonHangBan/DanhSach&id=<?=$row['ID']?>">Chi tiết  </a> 
                    ...
                    <?php } ?> -->
                    <a style="margin-left: 5px;padding: 7px 10px; font-size: 14px; background: #717171 ; color: #fff; border-radius: 5px;" target="_blank" href="../DonHangBan/InDonHang&id=<?=$row['ID']?>">In</a>
                </td>
