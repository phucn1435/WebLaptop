...
class TinTuc{
    ...
    public function ThemMoi($id, $ten, $hinhanh, $noidung)
    {
        $now=date("Y-m-d");
        $sql = "INSERT INTO tintuc(IDLoaiTinTuc,TenTinTuc,hinhanh,NoiDung,NgayDang) 
        VALUES ('$id','$ten','$hinhanh','$noidung', '$now')";
    ...
    public function DanhSach($item, $offset)
    {
        ...
        WHERE tt.IDLoaiTinTuc = ltt.ID ORDER BY NgayDang DESC LIMIT $item OFFSET $offset";
